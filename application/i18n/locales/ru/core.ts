...
export const ruCoreMessages: Messages = {
  ...
  'settings.update.hint': 'ALinLink проверяет обновления через GitHub Releases.',
  ...
  'settings.application.toolbox': 'Инструменты',
  'settings.application.exportVault': 'Экспорт хостов',
  'settings.application.exportVaultSubtitle': 'Экспорт всех хостов, ключей и настроек в JSON',
  'settings.application.exportTitle': 'Экспорт',
  'settings.application.exportSuccess': 'Экспорт успешен',
  'settings.application.exportFailed': 'Ошибка экспорта',
  'settings.application.importSshConfig': 'Импорт SSH Config',
  'settings.application.importSshConfigSubtitle': 'Импорт хостов из файла ~/.ssh/config',
  'settings.application.importTitle': 'Импорт',
  'settings.application.importSuccess': 'Импортировано {{count}} хостов',
  'settings.application.importNoHosts': 'Не найдено действительных конфигураций хостов',
  'settings.application.importFailed': 'Ошибка импорта, проверьте формат файла',
  'settings.application.clearCache': 'Очистить кэш',
  'settings.application.clearCacheSubtitle': 'Очистить локальные временные данные и кэш',
  'settings.application.clearCacheTitle': 'Очистить кэш',
  'settings.application.clearCacheSuccess': 'Кэш очищен',
  'settings.application.clearCacheFailed': 'Не удалось очистить кэш',
