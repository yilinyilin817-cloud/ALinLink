...
export const ruTerminalMessages: Messages = {
  ...
  'cloudSync.strategy.smartMergeDesc': 'По возможности объединять изменения с обеих сторон; если ALinLink не сможет безопасно выбрать, он попросит вас решить вручную.',
  ...
  'cloudSync.localBackups.desc': 'ALinLink сохраняет локальные точки восстановления перед сменой версии приложения и перед восстановлением хранилища.',
  'cloudSync.localBackups.retentionTitle': 'Хранение резервных копий',
  'cloudSync.localBackups.retentionDesc': 'Выберите, сколько локальных резервных копий должен хранить ALinLink.',
  ...
  'cloudSync.localBackups.unavailableDesc': 'Эта платформа не предоставляет ALinLink безопасное хранилище ключей, поэтому локальные резервные копии нельзя записывать безопасно. Установите ALinLink в систему с поддерживаемым keychain, чтобы включить историю локальных резервных копий.',
  ...
  'cloudSync.githubFlow.desc': 'Скопируйте код ниже и введите его на GitHub, чтобы авторизовать ALinLink.',
