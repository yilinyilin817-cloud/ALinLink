...
export const zhCNCoreMessages: Messages = {
  ...
  'settings.update.hint': 'ALinLink 从 GitHub Releases 检查更新。',
  ...
  'settings.application.toolbox': '实用工具箱',
  'settings.application.exportVault': '导出主机配置',
  'settings.application.exportVaultSubtitle': '将所有主机、密钥和配置导出为 JSON',
  'settings.application.exportTitle': '导出配置',
  'settings.application.exportSuccess': '配置导出成功',
  'settings.application.exportFailed': '配置导出失败',
  'settings.application.importSshConfig': '导入 SSH 配置',
  'settings.application.importSshConfigSubtitle': '从 ~/.ssh/config 文件导入主机',
  'settings.application.importTitle': '导入配置',
  'settings.application.importSuccess': '成功导入 {{count}} 个主机',
  'settings.application.importNoHosts': '未找到有效主机配置',
  'settings.application.importFailed': '导入失败，请检查文件格式',
  'settings.application.clearCache': '清空缓存',
  'settings.application.clearCacheSubtitle': '清理本地临时数据和缓存文件',
  'settings.application.clearCacheTitle': '清空缓存',
  'settings.application.clearCacheSuccess': '缓存清理成功',
  'settings.application.clearCacheFailed': '缓存清理失败',
  ...
  'pf.type.dynamic.desc': '动态转发将 ALinLink 作为 SOCKS 代理使用。',
