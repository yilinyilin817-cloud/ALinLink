...
export const enVaultMessages: Messages = {
  ...
  'pf.type.dynamic.desc': 'Dynamic port forwarding turns ALinLink into a SOCKS proxy server.',
  ...
  'hostDetails.algorithms.inheritedNotice': 'The current group has algorithm overrides set for: {categories}. The "Reset" button here falls back to the group\'s lists, not ALinLink\'s defaults. To ignore the group restriction, clear the override in the group\'s algorithm settings.',
