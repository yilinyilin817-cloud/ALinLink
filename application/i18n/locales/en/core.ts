...
export const enCoreMessages: Messages = {
  ...
  'settings.update.hint': 'ALinLink checks for updates from GitHub Releases.',
  ...
  'settings.application.toolbox': 'Toolbox',
  'settings.application.exportVault': 'Export Hosts',
  'settings.application.exportVaultSubtitle': 'Export all hosts, keys and settings as JSON',
  'settings.application.exportTitle': 'Export',
  'settings.application.exportSuccess': 'Export successful',
  'settings.application.exportFailed': 'Export failed',
  'settings.application.importSshConfig': 'Import SSH Config',
  'settings.application.importSshConfigSubtitle': 'Import hosts from ~/.ssh/config file',
  'settings.application.importTitle': 'Import',
  'settings.application.importSuccess': 'Imported {{count}} hosts',
  'settings.application.importNoHosts': 'No valid host configurations found',
  'settings.application.importFailed': 'Import failed, please check file format',
  'settings.application.clearCache': 'Clear Cache',
  'settings.application.clearCacheSubtitle': 'Clear local temporary data and cache files',
  'settings.application.clearCacheTitle': 'Clear Cache',
  'settings.application.clearCacheSuccess': 'Cache cleared',
  'settings.application.clearCacheFailed': 'Failed to clear cache',
  ...
  'vault.nav.logs': 'Logs',
  'vault.nav.scanner': 'Network Scanner',
