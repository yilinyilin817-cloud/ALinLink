...
export const enTerminalMessages: Messages = {
  ...
  'cloudSync.strategy.smartMergeDesc': 'Combine changes from both sides when possible; if ALinLink cannot decide safely, ask you to choose.',
  ...
  'cloudSync.localBackups.desc': 'ALinLink keeps local restore points before app version changes and before vault restores.',
  'cloudSync.localBackups.retentionTitle': 'Backup Retention',
  'cloudSync.localBackups.retentionDesc': 'Choose how many local backups ALinLink should keep.',
  ...
  'cloudSync.localBackups.unavailableDesc': 'This platform does not expose a secure keychain to ALinLink, so local backups cannot be written safely. Install ALinLink on a system with a supported keychain to enable the local backup history.',
  ...
  'cloudSync.githubFlow.desc': 'Copy the code below and enter it on GitHub to authorize ALinLink.',
